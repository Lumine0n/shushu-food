...
import { Map as MapIcon, MapPin, Search, Store } from "lucide-react";
        ...
        return <article key={place.id} className="soft-card p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-start justify-between gap-3"><h2 className="serif text-lg font-bold">{place.name}</h2><span className="shrink-0 text-sm font-extrabold text-[var(--red)]">{place.averagePriceCents != null ? `人均 ${formatPrice(place.averagePriceCents)}` : "价格未知"}</span></div>
